...
Route::post('/admin-dashboard', 'App\Http\Controllers\AdminController@dashboard'); //carfull
...
//delivery
Route::get('/delivery', 'App\Http\Controllers\DeliveryController@insert_delivery');
